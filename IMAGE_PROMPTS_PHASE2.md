...
### 7. History Buff
- **File:** `content/itineraries/naples-history-buff-guide.mdx`
- **Image:** `naples-historic-palm-cottage.jpg`
- **Prompt:** Photorealistic 4k image of the Historic Palm Cottage in Naples, oldest house in Naples, sunny day with palm trees.

### 8. Golf Escape
- **File:** `content/itineraries/naples-golf-escape-guide.mdx`
- **Image:** `naples-championship-golf-course.jpg`
- **Prompt:** Photorealistic 4k image of a pristine fairway on a championship golf course in Naples, Florida, with a lake and palm trees, morning dew.

## Luxury & Cars
### 9. Luxury Car
- **File:** `content/travel-tips/do-you-need-a-car-in-naples.mdx`
- **Image:** `naples-luxury-convertible-drive.jpg`
- **Prompt:** Photorealistic 4k image of a luxury convertible car driving along Gulf Shore Boulevard in Naples, with palm trees and ocean glimpses, sunny day.

### 10. Ultra Luxury
- **File:** `content/itineraries/naples-ultra-luxury-weekend.mdx`
- **Image:** `naples-port-royal-mansion-yacht.jpg`
- **Prompt:** Photorealistic 4k image of a stunning waterfront mansion in Port Royal, Naples, with a large yacht docked in the backyard canal, twilight.

## Rainy Day & Art
### 11. Kids Rainy Day
- **File:** `content/itineraries/naples-rainy-day-kids-guide.mdx`
...
## Sunset & Dogs
### 15. Sunset Lovers
- **File:** `content/itineraries/naples-sunset-lovers-guide.mdx`
- **Image:** `naples-beach-sunset-toast.jpg`
- **Prompt:** Photorealistic 4k close-up of two champagne glasses clinking against a backdrop of a fiery orange sunset on Naples beach.

### 16. Dog Friendly
- **File:** `content/itineraries/naples-dog-friendly-guide.mdx`
- **Image:** `naples-dog-on-beach.jpg`
- **Prompt:** Photorealistic 4k image of a happy golden retriever running on a white sand beach in Florida (Keewaydin Island), splashing in shallow water, sunny.

## Miscellaneous
### 17. Foodie Tour
- **File:** `content/itineraries/naples-ultimate-foodie-tour.mdx`
- **Image:** `naples-seafood-platter.jpg`
- **Prompt:** Photorealistic 4k image of a gourmet seafood platter featuring stone crab claws and shrimp at a waterfront restaurant in Naples, sunset background.

### 18. Family Toddler
- **File:** `content/itineraries/naples-family-toddler-guide.mdx`
...
### 20. Honeymoon
- **File:** `content/itineraries/naples-honeymoon-guide.mdx`
- **Image:** `naples-romantic-private-dinner-beach.jpg`
- **Prompt:** Photorealistic 4k image of a private romantic candlelight dinner set up directly on the sand of a Naples beach at dusk, tiki torches, romance.
