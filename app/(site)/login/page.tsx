        ...
        <div className="min-h-screen bg-gradient-to-br from-ocean-50 to-teal-50 flex items-center justify-center py-12 px-4">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">Sign in to access your saved trips and favorites</p>
                </div>
                ...
                <p className="mt-8 text-center text-gray-600">
                    ...
                    <Link href="/register" className="text-ocean-600 font-semibold hover:text-ocean-700">
                        Sign up free
                    </Link>
                </p>
            </motion.div>
